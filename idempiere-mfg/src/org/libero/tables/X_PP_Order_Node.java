...
// X
	...
	public BigDecimal getDurationRequiered() {
		BigDecimal bd = (BigDecimal) get_Value(COLUMNNAME_DurationRequiered);
		if (bd == null)
			return Env.ZERO;
		return bd;
	}
	...
	public void setSetupTimeRequiered(BigDecimal SetupTimeRequiered) {
		set_Value(COLUMNNAME_SetupTimeRequiered, SetupTimeRequiered);
	}

	/** Get Setup Time Requiered.
		@return Setup Time Required	  */
	public BigDecimal getSetupTimeRequiered() {
		BigDecimal bd = (BigDecimal) get_Value(COLUMNNAME_SetupTimeRequiered);
		if (bd == null)
			return Env.ZERO;
		return bd;
	}
