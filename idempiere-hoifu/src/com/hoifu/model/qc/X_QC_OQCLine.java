...
@org.adempiere.base.Model(table = "QC_OQCLine")
public class X_QC_OQCLine extends PO implements I_QC_OQCLine, I_Persistent {
	private static final long serialVersionUID = 20250512L;

	public X_QC_OQCLine(Properties ctx, int id, String trxName) {
		super(ctx, id, trxName);
	}

	public X_QC_OQCLine(Properties ctx, int id, String trxName, String... v) {
		super(ctx, id, trxName, v);
	}

	public X_QC_OQCLine(Properties ctx, String uuid, String trxName) {
		super(ctx, uuid, trxName);
	}

	public X_QC_OQCLine(Properties ctx, String uuid, String trxName, String... v) {
		super(ctx, uuid, trxName, v);
	}

	public X_QC_OQCLine(Properties ctx, ResultSet rs, String trxName) {
	...
	public String toString() {
		return "X_QC_OQCLine[" + get_ID() + "]";
	}

	@Override
	public void setQC_OQCLine_ID(int v) {
		if (v < 1)
			set_ValueNoCheck(COLUMNNAME_QC_OQCLine_ID, null);
		else
			set_ValueNoCheck(COLUMNNAME_QC_OQCLine_ID, v);
	}

	@Override
	public int getQC_OQCLine_ID() {
		Integer ii = (Integer) get_Value(COLUMNNAME_QC_OQCLine_ID);
		return ii == null ? 0 : ii;
	}

	@Override
	public void setQC_OQCLine_UU(String v) {
		set_Value(COLUMNNAME_QC_OQCLine_UU, v);
	}

	@Override
	public String getQC_OQCLine_UU() {
		return (String) get_Value(COLUMNNAME_QC_OQCLine_UU);
	}

	@Override
	public void setQC_OQC_ID(int v) {
		set_Value(COLUMNNAME_QC_OQC_ID, v);
	}
	...
	@Override
	public I_QC_OQC getQC_OQC() {
		return (I_QC_OQC) MTable.get(getCtx(), I_QC_OQC.Table_Name).getPO(getQC_OQC_ID(), get_TrxName());
	}
