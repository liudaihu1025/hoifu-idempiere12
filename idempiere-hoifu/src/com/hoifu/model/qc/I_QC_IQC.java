...
/**
 * Generated Interface for QC_IQC
 * 
 * @author iDempiere (generated)
 * @version Release 12
 */
@SuppressWarnings("all")
public interface I_QC_IQC {

	/** TableName=QC_IQC */
	public static final String Table_Name = "QC_IQC";
	...
	String COLUMNNAME_QC_IQC_UU = "QC_IQC_UU";

	void setQC_IQC_UU(String v);
	...
	String COLUMNNAME_VendorBatch = "VendorBatch";

	void setVendorBatch(String v);

	String getVendorBatch();
	...
	String COLUMNNAME_ReceiveDate = "ReceiveDate";

	void setReceiveDate(Timestamp v);
