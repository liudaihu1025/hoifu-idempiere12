...
@org.adempiere.base.Model(table = "QC_IPQCLine")
public class X_QC_IPQCLine extends PO implements I_QC_IPQCLine, I_Persistent {
	private static final long serialVersionUID = 20250512L;

	public X_QC_IPQCLine(Properties ctx, int id, String trxName) {
		super(ctx, id, trxName);
	}

	public X_QC_IPQCLine(Properties ctx, int id, String trxName, String... v) {
		super(ctx, id, trxName, v);
	}

	public X_QC_IPQCLine(Properties ctx, String uuid, String trxName) {
		super(ctx, uuid, trxName);
	}

	public X_QC_IPQCLine(Properties ctx, String uuid, String trxName, String... v) {
		super(ctx, uuid, trxName, v);
	}

	public X_QC_IPQCLine(Properties ctx, ResultSet rs, String trxName) {
	...
	public String toString() {
		return "X_QC_IPQCLine[" + get_ID() + "]";
	}

	@Override
	public void setQC_IPQCLine_ID(int v) {
		if (v < 1)
			set_ValueNoCheck(COLUMNNAME_QC_IPQCLine_ID, null);
		else
			set_ValueNoCheck(COLUMNNAME_QC_IPQCLine_ID, v);
	}

	@Override
	public int getQC_IPQCLine_ID() {
		Integer ii = (Integer) get_Value(COLUMNNAME_QC_IPQCLine_ID);
		return ii == null ? 0 : ii;
	}

	@Override
	public void setQC_IPQCLine_UU(String v) {
		set_Value(COLUMNNAME_QC_IPQCLine_UU, v);
	}

	@Override
	public String getQC_IPQCLine_UU() {
		return (String) get_Value(COLUMNNAME_QC_IPQCLine_UU);
	}

	@Override
	public void setQC_IPQC_ID(int v) {
		set_Value(COLUMNNAME_QC_IPQC_ID, v);
	}
	...
	@Override
	public I_QC_IPQC getQC_IPQC() {
		return (I_QC_IPQC) MTable.get(getCtx(), I_QC_IPQC.Table_Name).getPO(getQC_IPQC_ID(), get_TrxName());
	}
