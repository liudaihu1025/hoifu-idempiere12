...
@org.adempiere.base.Model(table = "QC_IQCLine")
public class X_QC_IQCLine extends PO implements I_QC_IQCLine, I_Persistent {
	private static final long serialVersionUID = 20250512L;

	public X_QC_IQCLine(Properties ctx, int id, String trxName) {
		super(ctx, id, trxName);
	}

	public X_QC_IQCLine(Properties ctx, int id, String trxName, String... v) {
		super(ctx, id, trxName, v);
	}

	public X_QC_IQCLine(Properties ctx, String uuid, String trxName) {
		super(ctx, uuid, trxName);
	}

	public X_QC_IQCLine(Properties ctx, String uuid, String trxName, String... v) {
		super(ctx, uuid, trxName, v);
	}

	public X_QC_IQCLine(Properties ctx, ResultSet rs, String trxName) {
	...
	public String toString() {
		return "X_QC_IQCLine[" + get_ID() + "]";
	}

	@Override
	public void setQC_IQCLine_ID(int v) {
		if (v < 1)
			set_ValueNoCheck(COLUMNNAME_QC_IQCLine_ID, null);
		else
			set_ValueNoCheck(COLUMNNAME_QC_IQCLine_ID, v);
	}

	@Override
	public int getQC_IQCLine_ID() {
		Integer ii = (Integer) get_Value(COLUMNNAME_QC_IQCLine_ID);
		return ii == null ? 0 : ii;
	}

	@Override
	public void setQC_IQCLine_UU(String v) {
		set_Value(COLUMNNAME_QC_IQCLine_UU, v);
	}

	@Override
	public String getQC_IQCLine_UU() {
		return (String) get_Value(COLUMNNAME_QC_IQCLine_UU);
	}

	@Override
	public void setQC_IQC_ID(int v) {
		set_Value(COLUMNNAME_QC_IQC_ID, v);
	}

	@Override
	public int getQC_IQC_ID() {
		Integer ii = (Integer) get_Value(COLUMNNAME_QC_IQC_ID);
		return ii == null ? 0 : ii;
	}

	@Override
	public I_QC_IQC getQC_IQC() {
		return (I_QC_IQC) MTable.get(getCtx(), I_QC_IQC.Table_Name).getPO(getQC_IQC_ID(), get_TrxName());
	}
