...
/**
 * Generated Interface for QC_RQC
 * 
 * @author iDempiere (generated)
 * @version Release 12
 */
@SuppressWarnings("all")
public interface I_QC_RQC {

	/** TableName=QC_RQC */
	public static final String Table_Name = "QC_RQC";
	...
	String COLUMNNAME_QC_RQC_ID = "QC_RQC_ID";

	void setQC_RQC_ID(int v);

	int getQC_RQC_ID();

	String COLUMNNAME_QC_RQC_UU = "QC_RQC_UU";

	void setQC_RQC_UU(String v);
	...
	String COLUMNNAME_RQCType = "RQCType";

	void setRQCType(String v);
	...
	String COLUMNNAME_QuantityApply = "QuantityApply";

	void setQuantityApply(BigDecimal v);

	BigDecimal getQuantityApply();
	...
	String COLUMNNAME_Disposition = "Disposition";

	void setDisposition(String v);
