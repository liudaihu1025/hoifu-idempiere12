...
/**
 * Generated Interface for QC_OQCLine
 * 
 * @author iDempiere (generated)
 * @version Release 12
 */
@SuppressWarnings("all")
public interface I_QC_OQCLine {

	/** TableName=QC_OQCLine */
	public static final String Table_Name = "QC_OQCLine";
	...
	String COLUMNNAME_QC_OQCLine_ID = "QC_OQCLine_ID";

	void setQC_OQCLine_ID(int v);

	int getQC_OQCLine_ID();

	String COLUMNNAME_QC_OQCLine_UU = "QC_OQCLine_UU";

	void setQC_OQCLine_UU(String v);

	String getQC_OQCLine_UU();
