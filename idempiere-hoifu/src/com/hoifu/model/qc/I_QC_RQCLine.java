...
/**
 * Generated Interface for QC_RQCLine
 * 
 * @author iDempiere (generated)
 * @version Release 12
 */
@SuppressWarnings("all")
public interface I_QC_RQCLine {

	/** TableName=QC_RQCLine */
	public static final String Table_Name = "QC_RQCLine";
	...
	String COLUMNNAME_QC_RQCLine_ID = "QC_RQCLine_ID";

	void setQC_RQCLine_ID(int v);

	int getQC_RQCLine_ID();

	String COLUMNNAME_QC_RQCLine_UU = "QC_RQCLine_UU";

	void setQC_RQCLine_UU(String v);

	String getQC_RQCLine_UU();
