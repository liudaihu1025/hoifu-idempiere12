...
/** Generated Interface for QC_AQL_SampleCode
 *  @author iDempiere (generated) 
 *  @version Release 12
 */
@SuppressWarnings("all")
public interface I_QC_AQL_SampleCode 
{

    /** TableName=QC_AQL_SampleCode */
    public static final String Table_Name = "QC_AQL_SampleCode";
    ...
    /** Column name QC_AQL_SampleCode_ID */
    public static final String COLUMNNAME_QC_AQL_SampleCode_ID = "QC_AQL_SampleCode_ID";
    ...
    /** Column name QC_AQL_SampleCode_UU */
    public static final String COLUMNNAME_QC_AQL_SampleCode_UU = "QC_AQL_SampleCode_UU";
    ...
    /** Column name InspectionLevel */
    public static final String COLUMNNAME_InspectionLevel = "InspectionLevel";
    ...
    /** Column name LotSizeMax */
    public static final String COLUMNNAME_LotSizeMax = "LotSizeMax";
    ...
    /** Column name LotSizeMin */
    public static final String COLUMNNAME_LotSizeMin = "LotSizeMin";
    ...
    public static final String COLUMNNAME_SampleSize = "SampleSize";
