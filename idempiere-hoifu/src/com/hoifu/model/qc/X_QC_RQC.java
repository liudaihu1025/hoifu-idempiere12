...
@org.adempiere.base.Model(table = "QC_RQC")
public class X_QC_RQC extends PO implements I_QC_RQC, I_Persistent {
	private static final long serialVersionUID = 20250512L;

	public X_QC_RQC(Properties ctx, int id, String trxName) {
		super(ctx, id, trxName);
	}

	public X_QC_RQC(Properties ctx, int id, String trxName, String... v) {
		super(ctx, id, trxName, v);
	}

	public X_QC_RQC(Properties ctx, String uuid, String trxName) {
		super(ctx, uuid, trxName);
	}

	public X_QC_RQC(Properties ctx, String uuid, String trxName, String... v) {
		super(ctx, uuid, trxName, v);
	}

	public X_QC_RQC(Properties ctx, ResultSet rs, String trxName) {
	...
	public String toString() {
		return "X_QC_RQC[" + get_ID() + ",DocumentNo=" + getDocumentNo() + "]";
	}

	@Override
	public void setQC_RQC_ID(int v) {
		if (v < 1)
			set_ValueNoCheck(COLUMNNAME_QC_RQC_ID, null);
		else
			set_ValueNoCheck(COLUMNNAME_QC_RQC_ID, v);
	}
	...
	@Override
	public void setQC_RQC_UU(String v) {
		set_Value(COLUMNNAME_QC_RQC_UU, v);
	}

	@Override
	public String getQC_RQC_UU() {
		return (String) get_Value(COLUMNNAME_QC_RQC_UU);
	}
	...
	@Override
	public void setRQCType(String v) {
		set_Value(COLUMNNAME_RQCType, v);
	}

	@Override
	public String getRQCType() {
		return (String) get_Value(COLUMNNAME_RQCType);
	}
	...
	@Override
	public void setQuantityApply(BigDecimal v) {
		set_Value(COLUMNNAME_QuantityApply, v);
	}

	@Override
	public BigDecimal getQuantityApply() {
		return (BigDecimal) get_Value(COLUMNNAME_QuantityApply);
	}
	...
	public void setDisposition(String v) {
		set_Value(COLUMNNAME_Disposition, v);
	}

	@Override
	public String getDisposition() {
		return (String) get_Value(COLUMNNAME_Disposition);
	}
