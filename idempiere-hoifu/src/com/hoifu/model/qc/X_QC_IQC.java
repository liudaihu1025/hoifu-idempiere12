...
@org.adempiere.base.Model(table = "QC_IQC")
public class X_QC_IQC extends PO implements I_QC_IQC, I_Persistent {
	private static final long serialVersionUID = 20250512L;

	public X_QC_IQC(Properties ctx, int id, String trxName) {
		super(ctx, id, trxName);
	}

	public X_QC_IQC(Properties ctx, int id, String trxName, String... v) {
		super(ctx, id, trxName, v);
	}

	public X_QC_IQC(Properties ctx, String uuid, String trxName) {
		super(ctx, uuid, trxName);
	}

	public X_QC_IQC(Properties ctx, String uuid, String trxName, String... v) {
		super(ctx, uuid, trxName, v);
	}

	public X_QC_IQC(Properties ctx, ResultSet rs, String trxName) {
	...
	public String toString() {
		return "X_QC_IQC[" + get_ID() + ",DocumentNo=" + getDocumentNo() + "]";
	}

	@Override
	public void setQC_IQC_ID(int v) {
		if (v < 1)
			set_ValueNoCheck(COLUMNNAME_QC_IQC_ID, null);
		else
			set_ValueNoCheck(COLUMNNAME_QC_IQC_ID, v);
	}
	...
	@Override
	public void setQC_IQC_UU(String v) {
		set_Value(COLUMNNAME_QC_IQC_UU, v);
	}

	@Override
	public String getQC_IQC_UU() {
		return (String) get_Value(COLUMNNAME_QC_IQC_UU);
	}
	...
	@Override
	public void setVendorBatch(String v) {
		set_Value(COLUMNNAME_VendorBatch, v);
	}

	@Override
	public String getVendorBatch() {
		return (String) get_Value(COLUMNNAME_VendorBatch);
	}
	...
	@Override
	public void setReceiveDate(Timestamp v) {
		set_Value(COLUMNNAME_ReceiveDate, v);
	}
