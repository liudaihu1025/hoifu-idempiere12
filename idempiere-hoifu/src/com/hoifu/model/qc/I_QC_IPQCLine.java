...
/**
 * Generated Interface for QC_IPQCLine
 * 
 * @author iDempiere (generated)
 * @version Release 12
 */
@SuppressWarnings("all")
public interface I_QC_IPQCLine {

	/** TableName=QC_IPQCLine */
	public static final String Table_Name = "QC_IPQCLine";
	...
	String COLUMNNAME_QC_IPQCLine_ID = "QC_IPQCLine_ID";

	void setQC_IPQCLine_ID(int v);

	int getQC_IPQCLine_ID();

	String COLUMNNAME_QC_IPQCLine_UU = "QC_IPQCLine_UU";

	void setQC_IPQCLine_UU(String v);

	String getQC_IPQCLine_UU();
