...
/** Generated Model for Gl_Voucher
 *  @author iDempiere (generated)
 *  @version Release 12 - $Id$ */
@org.adempiere.base.Model(table="Gl_Voucher")
public class X_Gl_Voucher extends PO implements I_Gl_Voucher, I_Persistent
{
    ...
    public X_Gl_Voucher (Properties ctx, int Gl_Voucher_ID, String trxName)
    {
...
// 0
    ...
    /** Standard Constructor */
    public X_Gl_Voucher (Properties ctx, int Gl_Voucher_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, Gl_Voucher_ID, trxName, virtualColumns);
      /** if (Gl_Voucher_ID == 0)
        {
			setAD_Table_ID (0);
			setC_AcctSchema_ID (0);
...
// 0
    ...
    /** Standard Constructor */
    public X_Gl_Voucher (Properties ctx, String Gl_Voucher_UU, String trxName)
    {
      super (ctx, Gl_Voucher_UU, trxName);
      /** if (Gl_Voucher_UU == null)
        {
			setAD_Table_ID (0);
			setC_AcctSchema_ID (0);
			setC_Currency_ID (0);
...
// 0
    ...
    /** Standard Constructor */
    public X_Gl_Voucher (Properties ctx, String Gl_Voucher_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, Gl_Voucher_UU, trxName, virtualColumns);
      /** if (Gl_Voucher_UU == null)
        {
			setAD_Table_ID (0);
			setC_AcctSchema_ID (0);
...
// 0
    ...
    /** Load Constructor */
    public X_Gl_Voucher (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_Gl_Voucher[")
	...
	*/
	...
	/** Set Gl_Voucher.
		@param Gl_Voucher_ID Gl_Voucher
	*/
	public void setGl_Voucher_ID (int Gl_Voucher_ID)
	{
		if (Gl_Voucher_ID < 1)
			set_ValueNoCheck (COLUMNNAME_Gl_Voucher_ID, null);
		else
			set_ValueNoCheck (COLUMNNAME_Gl_Voucher_ID, Integer.valueOf(Gl_Voucher_ID));
	}

	/** Get Gl_Voucher.
		@return Gl_Voucher	  */
	public int getGl_Voucher_ID()
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Gl_Voucher_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	*/
	...
	public org.compiere.model.I_AD_User getPoste() throws RuntimeException
	{
		return (org.compiere.model.I_AD_User)MTable.get(getCtx(), org.compiere.model.I_AD_User.Table_ID)
	...
	*/
	...
	public org.compiere.model.I_C_DocType getSource_DocType() throws RuntimeException
	{
		return (org.compiere.model.I_C_DocType)MTable.get(getCtx(), org.compiere.model.I_C_DocType.Table_ID)
