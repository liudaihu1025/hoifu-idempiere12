...
/** Generated Model for dy_graphicdesign
 *  @author iDempiere (generated)
 *  @version Release 12 - $Id$ */
@org.adempiere.base.Model(table="dy_graphicdesign")
public class X_dy_graphicdesign extends PO implements I_dy_graphicdesign, I_Persistent
{
    ...
    public X_dy_graphicdesign (Properties ctx, int dy_graphicdesign_ID, String trxName)
    {
      super (ctx, dy_graphicdesign_ID, trxName);
      /** if (dy_graphicdesign_ID == 0)
        {
			setAD_User_ID (0);
    ...
    /** Standard Constructor */
    public X_dy_graphicdesign (Properties ctx, int dy_graphicdesign_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, dy_graphicdesign_ID, trxName, virtualColumns);
      /** if (dy_graphicdesign_ID == 0)
        {
			setAD_User_ID (0);
			setdy_graphicdesign_ID (0);
    ...
    /** Standard Constructor */
    public X_dy_graphicdesign (Properties ctx, String dy_graphicdesign_UU, String trxName)
    {
      super (ctx, dy_graphicdesign_UU, trxName);
      /** if (dy_graphicdesign_UU == null)
        {
			setAD_User_ID (0);
			setdy_graphicdesign_ID (0);
			setdy_samplingdemand_ID (0);
    ...
    /** Standard Constructor */
    public X_dy_graphicdesign (Properties ctx, String dy_graphicdesign_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, dy_graphicdesign_UU, trxName, virtualColumns);
      /** if (dy_graphicdesign_UU == null)
        {
			setAD_User_ID (0);
			setdy_graphicdesign_ID (0);
    ...
    /** Load Constructor */
    public X_dy_graphicdesign (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_dy_graphicdesign[")
	...
	*/
	...
	/** &#24050;&#23436;&#25104; = CO */
	public static final String DESIGNSTATUS_已完成 = "CO";
	/** &#33609;&#31295; = DR */
	public static final String DESIGNSTATUS_草稿 = "DR";
	/** &#35780;&#23457;&#20013; = RV */
	public static final String DESIGNSTATUS_评审中 = "RV";
	/** &#24453;&#35780;&#23457; = WR */
	public static final String DESIGNSTATUS_待评审 = "WR";
	/** Set designstatus.
	...
	*/
	public void setdesignstatus (String designstatus)
	{
		...
		set_Value (COLUMNNAME_designstatus, designstatus);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_designstatus);
	}
	...
	*/
	...
	/** Set dy_graphicdesign_UU.
		@param dy_graphicdesign_UU dy_graphicdesign_UU
	*/
	public void setdy_graphicdesign_UU (String dy_graphicdesign_UU)
	{
		set_ValueNoCheck (COLUMNNAME_dy_graphicdesign_UU, dy_graphicdesign_UU);
	}

	/** Get dy_graphicdesign_UU.
		@return dy_graphicdesign_UU	  */
	public String getdy_graphicdesign_UU()
	{
		return (String)get_Value(COLUMNNAME_dy_graphicdesign_UU);
	}
