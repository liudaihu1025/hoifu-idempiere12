...
import com.hoifu.window.HFFindWindow;


@Component(service = IFindWindowFactory.class, property = {"service.ranking:Integer=100"})  
public class HFFindWindowFactory implements IFindWindowFactory {  
    ...
    public FindWindow getInstance(int targetWindowNo, int targetTabNo, String title,  
        ...
        // 返回自定义的FindWindow实例  
        return new HFFindWindow(targetWindowNo, targetTabNo, title,  
