...
public abstract class AbstractWQuickEntry extends Window implements Component, ISupportMask, EventListener<Event>, ValueChangeListener
{
	...
	/**
	 * Pre-fill a field by column name (used to carry display value into new record
	 * dialog). Default is no-op; subclasses may override.
	 * 
	 * @param columnName column name of the target field
	 * @param value      value to set
	 */
	public abstract void setFieldValue(String columnName, Object value);
