...
public class DrillEvent extends Event {
	...
	public static class DrillData {
		...
		// 新增构造函数：支持行数据
		public DrillData(MQuery query, String columnName, Object value, String displayValue, Object data, Object rowData) {
			this(query, columnName, value, displayValue, data);
