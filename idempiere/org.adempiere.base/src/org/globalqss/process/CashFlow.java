...
public class CashFlow  extends SvrProcess {
	...
	protected String doIt() throws Exception {
		...
		String sqlUpdate = "UPDATE T_CashFlow cf SET AccountValue = ev.Value, AccountName = ev.Name "
				+ "FROM C_ElementValue ev WHERE ev.C_ElementValue_ID = cf.C_ElementValue_ID "
				+ "AND cf.AD_PInstance_ID = ?";

		int no = DB.executeUpdate(sqlUpdate, getAD_PInstance_ID(), get_TrxName());
