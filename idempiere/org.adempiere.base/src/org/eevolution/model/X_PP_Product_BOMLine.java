...
// -1
	...
	*/
	...
	public String getKeymat() {
		return (String) get_Value(COLUMNNAME_Keymat);
	}
	 ...
	 * Set Approved.
	 * 
	 * @param IsApproved Indicates if this document was approved
	 */
	 ...
	 * Get Approved.
	 * 
	 * @return Indicates if this document was approved
	 */
	 ...
	 * Set Approved By.
	 * 
	 * @param ApprovedBy User who approved this document
	 */
	public void setApprovedBy(int ApprovedBy) {
		if (ApprovedBy < 1)
			set_Value(COLUMNNAME_ApprovedBy, null);
		else
	 ...
	 * Get Approved By.
	 * 
	 * @return User who approved this document
	 */
	 ...
	 * Set Submitted Time.
	 * 
	 * @param SubmittedTime When the document was submitted
	 */
	public void setSubmittedTime(Timestamp SubmittedTime) {
		set_Value(COLUMNNAME_SubmittedTime, SubmittedTime);
	}

	/**
	 * Get Submitted Time.
	 * 
	 * @return When the document was submitted
	 */
	public Timestamp getSubmittedTime() {
		return (Timestamp) get_Value(COLUMNNAME_SubmittedTime);
	}

	/**
	 * Set Approved Time.
	 * 
	 * @param ApprovedTime When the document was approved
	 */
	 ...
	 * Get Approved Time.
	 * 
	 * @return When the document was approved
	 */
	 ...
	 * 
	 * @param AD_WF_Process_ID Workflow Process Instance
	 */
	 ...
	 * 
	 * @return Workflow Process Instance
	 */
	 ...
	 * Set BOM Status.
	 * 
	 * @param BOMStatus BOM Status
	 */
	public void setBOMStatus(String BOMStatus) {
		set_Value(COLUMNNAME_BOMStatus, BOMStatus);
	}
	...
	public String getBOMStatus() {
		return (String) get_Value(COLUMNNAME_BOMStatus);
	}
