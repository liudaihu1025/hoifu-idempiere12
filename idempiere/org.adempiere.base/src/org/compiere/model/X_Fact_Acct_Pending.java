...
/** Generated Model for Fact_Acct_Pending
 *  @author iDempiere (generated)
 *  @version Release 12 - $Id$ */
@org.adempiere.base.Model(table="Fact_Acct_Pending")
public class X_Fact_Acct_Pending extends PO implements I_Fact_Acct_Pending, I_Persistent
{
    ...
    public X_Fact_Acct_Pending (Properties ctx, int Fact_Acct_Pending_ID, String trxName)
    {
      super (ctx, Fact_Acct_Pending_ID, trxName);
      /** if (Fact_Acct_Pending_ID == 0)
        {
			setAD_Table_ID (0);
			setAccount_ID (0);
    ...
    /** Standard Constructor */
    public X_Fact_Acct_Pending (Properties ctx, int Fact_Acct_Pending_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, Fact_Acct_Pending_ID, trxName, virtualColumns);
      /** if (Fact_Acct_Pending_ID == 0)
        {
			setAD_Table_ID (0);
			setAccount_ID (0);
    ...
    /** Standard Constructor */
    public X_Fact_Acct_Pending (Properties ctx, String Fact_Acct_Pending_UU, String trxName)
    {
      super (ctx, Fact_Acct_Pending_UU, trxName);
      /** if (Fact_Acct_Pending_UU == null)
        {
			setAD_Table_ID (0);
			setAccount_ID (0);
			setAmtAcctCr (Env.ZERO);
    ...
    /** Standard Constructor */
    public X_Fact_Acct_Pending (Properties ctx, String Fact_Acct_Pending_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, Fact_Acct_Pending_UU, trxName, virtualColumns);
      /** if (Fact_Acct_Pending_UU == null)
        {
			setAD_Table_ID (0);
			setAccount_ID (0);
    ...
    /** Load Constructor */
    public X_Fact_Acct_Pending (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_Fact_Acct_Pending[")
	...
	*/
	...
	{
		return (I_A_Asset)MTable.get(getCtx(), I_A_Asset.Table_ID)
	...
	*/
	...
	{
		return (I_C_ElementValue)MTable.get(getCtx(), I_C_ElementValue.Table_ID)
	...
	*/
	...
	{
		return (I_C_Activity)MTable.get(getCtx(), I_C_Activity.Table_ID)
	...
	*/
	...
	{
		return (I_C_BPartner)MTable.get(getCtx(), I_C_BPartner.Table_ID)
	...
	*/
	...
	{
		return (I_C_Campaign)MTable.get(getCtx(), I_C_Campaign.Table_ID)
	...
	*/
	...
	{
		return (I_C_ProjectPhase)MTable.get(getCtx(), I_C_ProjectPhase.Table_ID)
	...
	*/
	...
	{
		return (I_C_ProjectTask)MTable.get(getCtx(), I_C_ProjectTask.Table_ID)
	...
	*/
	...
	{
		return (I_C_Project)MTable.get(getCtx(), I_C_Project.Table_ID)
	...
	*/
	...
	{
		return (I_C_SalesRegion)MTable.get(getCtx(), I_C_SalesRegion.Table_ID)
	...
	*/
	...
	{
		return (I_C_SubAcct)MTable.get(getCtx(), I_C_SubAcct.Table_ID)
	...
	*/
	...
	{
		return (I_C_Tax)MTable.get(getCtx(), I_C_Tax.Table_ID)
	...
	*/
	...
	{
		return (I_C_UOM)MTable.get(getCtx(), I_C_UOM.Table_ID)
	...
	*/
	...
	/** Set Fact_Acct_Pending.
		@param Fact_Acct_Pending_ID Fact_Acct_Pending
	*/
	public void setFact_Acct_Pending_ID (int Fact_Acct_Pending_ID)
	{
		if (Fact_Acct_Pending_ID < 1)
			set_ValueNoCheck (COLUMNNAME_Fact_Acct_Pending_ID, null);
		else
			set_ValueNoCheck (COLUMNNAME_Fact_Acct_Pending_ID, Integer.valueOf(Fact_Acct_Pending_ID));
	}

	/** Get Fact_Acct_Pending.
		@return Fact_Acct_Pending	  */
	public int getFact_Acct_Pending_ID()
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Fact_Acct_Pending_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	/** Set Fact_Acct_Pending_UU.
		@param Fact_Acct_Pending_UU Fact_Acct_Pending_UU
	*/
	public void setFact_Acct_Pending_UU (String Fact_Acct_Pending_UU)
	{
		set_ValueNoCheck (COLUMNNAME_Fact_Acct_Pending_UU, Fact_Acct_Pending_UU);
	}

	/** Get Fact_Acct_Pending_UU.
		@return Fact_Acct_Pending_UU	  */
	public String getFact_Acct_Pending_UU()
	{
		return (String)get_Value(COLUMNNAME_Fact_Acct_Pending_UU);
	}

	public I_GL_Budget getGL_Budget() throws RuntimeException
	{
		return (I_GL_Budget)MTable.get(getCtx(), I_GL_Budget.Table_ID)
	...
	*/
	...
	public I_Gl_Voucher_Pending getGl_Voucher_Pending() throws RuntimeException
	{
		return (I_Gl_Voucher_Pending)MTable.get(getCtx(), I_Gl_Voucher_Pending.Table_ID)
			.getPO(getGl_Voucher_Pending_ID(), get_TrxName());
	}
	...
	*/
	...
	{
		return (I_M_Product)MTable.get(getCtx(), I_M_Product.Table_ID)
