...
public class MSysConfig extends X_AD_SysConfig
{
    ...
    public static final String EXPORT_INCLUDE_REFERENCE_FIELDS = "EXPORT_INCLUDE_REFERENCE_FIELDS"; // 报表导出为M_Product_ID、C_BPartner_ID、C_Order_ID、PP_Order_ID 导出时自动添加Value/docmentNo、Name、Description 字段，配置Y/N
    public static final String BALANCE_SHEET_ITEMS = "BALANCE_SHEET_ITEMS"; // 资产负债表展示行数据定义
    public static final String BALANCE_SHEET_FORMULA_LEFT = "BALANCE_SHEET_FORMULA_LEFT"; // 资产负债表左列计算公式
    public static final String BALANCE_SHEET_FORMULA_RIGHT = "BALANCE_SHEET_FORMULA_RIGHT"; // 资产负债表右列计算公式
    public static final String OA_API_URL_PREFIX = "OA_API_URL_PREFIX"; // OA域名前缀
    public static final String OA_TOKEN_USER_ID = "OA_TOKEN_USER_ID"; // OA系统获取token userId
