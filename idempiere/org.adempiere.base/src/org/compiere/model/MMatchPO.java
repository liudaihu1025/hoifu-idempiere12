...
//						String msg = "Failed to update match po.";
						String msg = Msg.getMsg(ctx, "FailedToUpdateMatchPO");  
...
//									String msg = "Failed to create match inv.";
									String msg = Msg.getMsg(ctx, "FailedToCreateMatchInv"); 
									ValueNamePair error = CLogger.retrieveError();
									if (error != null)
									{
										msg = msg + " " + error.getName();
...
//				String msg = "Failed to auto match invoice.";
				String msg = Msg.getMsg(mpo.getCtx(), "FailedToCreateMatchInv"); 
				ValueNamePair error = CLogger.retrieveError();
				if (error != null)
				{
					msg = msg + " " + error.getName();
...
//							String msg = "Failed to create match po";
							String msg = Msg.getMsg(getCtx(), "FailedToCreateMatchPO");
							ValueNamePair error = CLogger.retrieveError();
							if (error != null)
								msg = msg + " " + error.getName();
							throw new RuntimeException(msg);
	...
	protected boolean afterSave (boolean newRecord, boolean success)
	{
		...
		{  
		    ...
		    {  
		        ...
		        {  
		            boolean isSOTrx = line.getParent().isSOTrx();  
		            String messageKey = isSOTrx ? "SOMatchedQtyGtMovementQty" : "POMatchedQtyGtMovementQty";  
		            throw new IllegalStateException(Msg.getMsg(getCtx(), messageKey,   
		                new Object[]{matchedQty, line.getMovementQty(), line.getParent().getDocumentNo() +"_" +line.getLine()}));  
		        }  
		    }  
		    ...
		    {  
		        ...
		        {  
		            boolean isSOTrx = line.getParent().isSOTrx();  
		            String messageKey = isSOTrx ? "ARMatchedQtyGtInvoicedQty" : "APMatchedQtyGtInvoicedQty";  
		            throw new IllegalStateException(Msg.getMsg(getCtx(), messageKey,   
		                new Object[]{matchedQty, line.getQtyInvoiced(), line.getParent().getDocumentNo() +"_" +line.getLine()}));  
		        }  
		    }  
		    ...
		    {  
		        ...
		        {  
		            ...
		            {  
		                String messageKey = isSOTrx ? "SOMatchedInvoicedQtyGtOrderedQty" : "POMatchedInvoicedQtyGtOrderedQty";  
		                throw new IllegalStateException(Msg.getMsg(getCtx(), messageKey,   
		                    new Object[]{invoicedQty, qtyOrdered, line.getParent().getDocumentNo() +"_" +line.getLine()}));  
		            }  
		            ...
		            {  
		                String messageKey = isSOTrx ? "SOMatchedDeliveredQtyGtOrderedQty" : "POMatchedDeliveredQtyGtOrderedQty";  
		                throw new IllegalStateException(Msg.getMsg(getCtx(), messageKey,   
		                    new Object[]{deliveredQty, qtyOrdered, line.getParent().getDocumentNo() +"_" +line.getLine()}));  
		            }  
		        }  
		    }  
		}
