...
// 0
	...
	*/
	...
	public static final String COLUMNNAME_AnyRecurring = "AnyRecurring";

	public void setAnyRecurring(boolean AnyRecurring) {
		set_Value(COLUMNNAME_AnyRecurring, Boolean.valueOf(AnyRecurring));
	}

	public boolean isAnyRecurring() {
		Object oo = get_Value(COLUMNNAME_AnyRecurring);
		if (oo != null) {
			if (oo instanceof Boolean) return ((Boolean)oo).booleanValue();
			return "Y".equals(oo);
		}
		return true; // 默认 true，向后兼容
	}
