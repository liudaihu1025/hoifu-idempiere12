...
// N
	...
	*/
	...
	public String getGroupByColumn() {
		return (String) get_Value("GroupByColumn");
	}

	public void setGroupByColumn(String GroupByColumn) {
		set_Value("GroupByColumn", GroupByColumn);
	}

	public boolean isGroupEnabled() {
		Object oo = get_Value("IsGroupEnabled");
		if (oo != null) {
			if (oo instanceof Boolean)
				return ((Boolean) oo).booleanValue();
			return "Y".equals(oo);
	...
	public void setIsGroupEnabled(boolean IsGroupEnabled) {
		set_Value("IsGroupEnabled", IsGroupEnabled ? "Y" : "N");
	}
}