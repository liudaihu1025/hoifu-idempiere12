...
/** Generated Interface for Gl_Voucher_Pending
 *  @author iDempiere (generated) 
 *  @version Release 12
 */
@SuppressWarnings("all")
public interface I_Gl_Voucher_Pending 
{

    /** TableName=Gl_Voucher_Pending */
    public static final String Table_Name = "Gl_Voucher_Pending";
    ...
    public static final String COLUMNNAME_AttachmentCount = "AttachmentCount";
    ...
    /** Column name Gl_VoucherType */
    public static final String COLUMNNAME_Gl_VoucherType = "Gl_VoucherType";
    ...
    /** Column name Gl_Voucher_Pending_UU */
    public static final String COLUMNNAME_Gl_Voucher_Pending_UU = "Gl_Voucher_Pending_UU";
    ...
    public static final String COLUMNNAME_PostedBy = "PostedBy";
 ...
 lowest number comes first
    ...
    /** Column name Source_DocType_ID */
    public static final String COLUMNNAME_Source_DocType_ID = "Source_DocType_ID";
    ...
    public static final String COLUMNNAME_approvedtime = "approvedtime";
