...
// N
	...
	*/
	...
	/** Custom Credit Check = A */
	public static final String SOCREDITSTATUS_CustomCreditCheck = "A";
	/** Set Credit Status.
	...
	*/
	...
	/** Set Temporary Credit Limit.
	 @param TempCreditLimit Temporary outstanding invoice amounts allowed
	 */
	public void setTempCreditLimit (BigDecimal TempCreditLimit)
	{
		set_Value (COLUMNNAME_TempCreditLimit, TempCreditLimit);
	}

	/** Get Temporary Credit Limit.
	 @return Temporary outstanding invoice amounts allowed
	 */
	public BigDecimal getTempCreditLimit()
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_TempCreditLimit);
		if (bd == null)
			return Env.ZERO;
		return bd;
	}

	/** Set Temporary Credit Limit Valid From.
	 @param TempCreditLimitValidFrom Temporary Credit Limit valid from including this date (first day)
	 */
	...
	/** Get Temporary Credit Limit Valid From.
	 @return Temporary Credit Limit valid from including this date (first day)
	 */
	...
	/** Set Temporary Credit Limit Valid To.
	 @param TempCreditLimitValidTo Temporary Credit Limit valid to including this date (last day)
	 */
	...
	/** Get Temporary Credit Limit Valid To.
	 @return Temporary Credit Limit valid to including this date (last day)
	 */
