...
import com.trekglobal.idempiere.rest.api.v1.resource.hoifu.ProductResourceImpl;
...
public class ApplicationV1 extends Application {
    ...
    public Set<Class<?>> getClasses() {
		...
		// 添加CORS过滤器（优先级最高）
		classes.add(com.trekglobal.idempiere.rest.api.v1.auth.filter.CORSFilter.class);
        ...
        classes.add(ProductResourceImpl.class);
